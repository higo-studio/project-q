...
public static class CharacterControllerUtilities
{
    ...
    public static unsafe void CheckSupport(
        ...
        out CharacterSupportState characterState, out float3 surfaceNormal, out float3 surfaceVelocity/* N,
        ativeList<StatefulCollisionEvent> collisionEvents = default */)
    {
