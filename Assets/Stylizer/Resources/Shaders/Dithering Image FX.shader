		...
		Pass 
		{
			...
			CGPROGRAM
				...
				fixed4 frag(Input i) : COLOR 
				{
					...
					fixed3 color = GetDitherColor(LinearToGammaSpace(c.rgb), _PatternTex, _PaletteTex, _PaletteHeight, i.ditherPos, _PaletteColorCount, _PatternScale);
					return fixed4(GammaToLinearSpace(color), c.a);
